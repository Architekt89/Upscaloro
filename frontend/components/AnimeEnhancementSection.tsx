...
export default function AnimeEnhancementSection() {
      ...
      <section className="relative bg-[#000000] overflow-hidden py-16 md:py-24">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="w-full rounded-xl overflow-hidden shadow-2xl" style={{ aspectRatio: '5/4' }}>
    ...
    <section className="relative bg-[#000000] overflow-hidden py-16 md:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight mb-3">
            <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-white bg-clip-text text-transparent">
              Flawless Anime Upscaling
            </span>
          </h2>
          <p className="max-w-2xl mx-auto text-gray-300 text-lg md:text-xl mb-8">
            Waifu Mode perfects every detail—sharpening line art, boosting color vibrancy, and maintaining the authentic charm of anime and cartoons.
          </p>
        </div>
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-8">
          <ImageSlider 
            beforeImage="/Images/anime_bfore.png"
            afterImage="/Images/anime_after.png"
            beforeAlt="Anime before enhancement"
            afterAlt="Anime after enhancement"
          />
          <ImageSlider 
            beforeImage="/Images/anim_before.png"
            afterImage="/Images/anim_after.png"
            beforeAlt="Anime character before enhancement"
            afterAlt="Anime character after enhancement"
          />
        </div>
