      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-base text-gray-500 dark:text-gray-400">
              AI-powered image upscaling for professionals and enthusiasts.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/models" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  AI Models
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/api-docs" className="text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                  API
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0">
            &copy; {new Date().getFullYear()} Upscalor. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
