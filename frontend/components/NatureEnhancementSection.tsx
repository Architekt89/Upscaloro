...
export default function NatureEnhancementSection() {
    ...
    <section className="relative bg-[#000000] overflow-hidden py-16 md:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-8">
          <ImageSlider 
            beforeImage="/Images/bear_before.png"
            afterImage="/Images/bear_after.png"
            beforeAlt="Bear before enhancement"
            afterAlt="Bear after enhancement"
          />
          <ImageSlider 
            beforeImage="/Images/bison_before.png"
            afterImage="/Images/bison_after.jpg"
            beforeAlt="Bison before enhancement"
            afterAlt="Bison after enhancement"
          />
        </div>
